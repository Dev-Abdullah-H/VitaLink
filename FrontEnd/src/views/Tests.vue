  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <section class="rounded-lg shadow-md px-6 py-8 bg-gray-100">
        ...
        <ul class="test-list">
          <div v-if="testResult.heartData.length == 0" class="text-center border shadow-lg p-4 rounded-lg mb-4 bg-slate-50">
      ...
      <section class="rounded-lg shadow-md px-6 py-8 bg-gray-200">
        ...
        <ul class="test-list">
          <div v-if="testResult.urineData.length == 0" class="text-center border shadow-lg p-4 rounded-lg mb-4 bg-slate-50">
            <h1>No Test Results Found</h1>
          </div>
          <li
            class="border shadow-lg p-4 rounded-lg mb-4 bg-slate-50"
      ...
      <section class="rounded-lg shadow-md px-6 py-8 bg-gray-100">
        ...
        <ul class="test-list">
          <div v-if="testResult.bloodData.length == 0" class="text-center border shadow-lg p-4 rounded-lg mb-4 bg-slate-50">
            <h1>No Test Results Found</h1>
          </div>
          <li
            class="border shadow-lg p-4 rounded-lg mb-4 bg-slate-50"
      ...
      <section class="rounded-lg shadow-md px-6 py-8 bg-gray-100">
        ...
        <ul class="test-list">
          <div v-if="testResult.bmiData.length == 0" class="text-center border shadow-lg p-4 rounded-lg mb-4 bg-slate-50">
            <h1>No Test Results Found</h1>
          </div>
          <li
            class="border shadow-lg p-4 rounded-lg mb-4 bg-slate-50"
